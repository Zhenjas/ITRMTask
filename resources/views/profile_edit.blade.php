...
@section('content')
    <div class="main-body">
        ...
        <div class="form">
            <form id="register-form" method="POST" action="" aria-label="{{ __('Register') }}">
                        @csrf
                ...
                <div class="field">
                    ...
                    <input type="text" class="input-group" name="email" value="{{Auth::user()->email}}">
                ...
                <div class="field">
                    ...
                    <input type="text" class="input-group" name="country" value="{{Auth::user()->country}}">
